...
- [ ] Now press Escape on purpose. Confirm it shows a short explanation of the concept, not an immediate skip — this is meant to help if you're stuck, not just a "why are you skipping" prompt.
